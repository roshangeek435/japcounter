  ...
  return (
    <>
      <SeoHead
        ...
        description="Free meditation timer with preset durations, ambient music, breathing guide animation and full‑screen mode."
        canonical={siteUrl('/meditation-timer')}
      />
