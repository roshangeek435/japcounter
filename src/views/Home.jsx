	...
	return (
		<>
			...
			<section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
				<h2 className="font-serif text-3xl text-[#7B1C1C] mb-4">Why Japa Counter?</h2>
				<p className="text-[#1A1A1A]/80 leading-relaxed">
					A traditional mala has 108 beads — a sacred number woven into Vedic cosmology. Whether you chant Om, Ram, Radhe, or any mantra of your heart, this free tool gently keeps count so your mind can stay with
					the sound. Your data lives only on your device. No accounts. No tracking. Just devotion.
				</p>
			</section>
		</>
	);
