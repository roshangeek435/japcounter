                  ...
                  <DialogContent className="bg-[#FFF8EE] border-[#D4AF37]/40 max-w-2xl max-h-[85vh] overflow-y-auto">
                    ...
                    <div className="space-y-4 mt-2">
                      ...
                      <div className="flex flex-wrap gap-2 pt-3 border-t border-[#D4AF37]/30">
                        ...
                        <Button asChild className="ml-auto rounded-full bg-[#FF6B00] hover:bg-[#7B1C1C]" data-testid={`start-japa-${m.id}`}>
                          <Link href={`/counter/${m.id}`}>Start Japa →</Link>
                        </Button>
                      </div>
                    </div>
                  </DialogContent>
                </Dialog>
                <Button asChild className="ml-auto rounded-full bg-[#FF6B00] hover:bg-[#7B1C1C] text-xs" data-testid={`library-open-${m.id}`}>
                  <Link href={`/counter/${m.id}`}>
