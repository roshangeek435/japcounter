...
export const ShareButtons = ({ mantraName, malas, onDownload, onCopyMessage }) => {
	const [url, setUrl] = useState(configuredSiteUrl("/"));
	...
	return (
		<div
			className="bg-white rounded-2xl border border-[#D4AF37]/30 p-5 shadow-sm"
			...
			<div className="grid grid-cols-2 sm:grid-cols-5 gap-2">
				...
				<button
					onClick={() => {
						...
						toast.success("Caption copied. Now post the downloaded image to Instagram!");
					}}
