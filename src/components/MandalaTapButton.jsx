...
export const MandalaTapButton = ({ count, total = 108, onTap, label = 'Tap to chant', sparkle = false }) => {
  ...
  return (
    <div className="relative inline-block" data-testid="tap-button-wrapper">
      ...
      <motion.button
        onClick={onTap}
        whileTap={{ scale: 0.92 }}
        className="lotus-pulse absolute inset-0 m-auto w-[200px] h-[200px] rounded-full bg-gradient-to-br from-[#FFF3DD] via-[#FFE7BE] to-[#FFD699] border-4 border-[#D4AF37]/50 flex items-center justify-center overflow-hidden"
        aria-label={label}
      ...
      {sparkle && (
        <div className="sparkle absolute inset-0 m-auto w-[260px] h-[260px] rounded-full pointer-events-none" style={{
